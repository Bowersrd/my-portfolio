<template>
    <section class="max-w-7xl mx-auto text-center px-5 mb-16 lg:pt-10">
        <h2 class="text-primary text-2xl font-bold uppercase mb-4 md:text-3xl lg:text-4xl">Who I Am<span
        ...
        <p class="font-secondary mt-5 leading-relaxed md:text-lg lg:text-xl">
            ...
            and home life to coding. Coding is something I quickly fell in love with and my main front end strength is
            with Vue. I am very familiar with Vue 2 but have quickly began to love Vue 3 with all the new updates. I am
            a programmer who loves new challenges and never stops learning. I build websites, I work with electron to
        ...
        <p class="font-secondary mt-5 leading-relaxed md:text-lg lg:text-xl">
            ...
            have strengthed through my current profression. Being self taught is my greatest strength, that might sound
